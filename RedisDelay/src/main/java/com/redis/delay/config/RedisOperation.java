...
/**
 * @ClassName:     RedisOperation.java
 * @Description:   TODO(用一句话描述该文件做什么) 
 * 
 * @author
 * @version         V1.0  
 * @param <T>
 * @Date           Jun 28, 2019 10:56:32 AM 
 */
@Component
public class RedisOperation {
     ...
     * @return
     */
    public  <T> T get(final String key ,Class<T> object) {
        Object result = null;
        ValueOperations<String, Object> operations = redisTemplate.opsForValue();
...
//		return  (T) andSet;
	...
	public List<String> multiGet(Collection<String> keys) {
		...
		List<Object> objects = forValue.multiGet(keys);

		Object key=objects;

		List<String> ksys=(List<String>)key;
