...
(/** @lends <global> */function( $ ) {
	 ...
	 *
	 * @param {object} oSettings dataTables settings object
	 * @param {array} data Data to producer to the server, required by
	...
	DataTable.defaults = {
		 ...
		 * parameters are:
		 *
		 * 1. _object_ - Data to producer to the server
		 ...
		 *  @param {array} data A key/value pair object containing the data to producer
		 *    to the server
		 ...
		 * superseded by that provided through `ajax`, which should be used instead.
		 *
		 *  It is often useful to producer extra data to the server when making an Ajax
		 * request - for example custom filtering information, and this callback
		 * function makes it trivial to producer extra information to the server. The
