...
public class TopicConfig {
    ...
    */
    ...
    public Queue queue(){
        ...
        return new Queue("topic.first",true,false,false,null);
    }
    ...
    public Queue secondQueue() {
        ...
        return new Queue("topic.second",true,false,false,null);
    }
    ...
    Binding bindingExchangeForMessage ( Queue queue, TopicExchange exchange){
        ...
        return BindingBuilder.bind(queue).to(exchange).with("topic.first");
    }
